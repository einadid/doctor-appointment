...
// Appointment stats
$appt_stats = mysqli_fetch_assoc(mysqli_query(
    $conn,
                    ...
                    <div class="report-grid">
                        <div class="report-box">
                            ...
                            <table class="report-table">
                                ...
                                <tr>
                                    <td>Pending</td>
                                    <td style="color:#f59e0b;"><?= $appt_stats['pending'] ?? 0 ?></td>
                                </tr>
                                <tr>
                                    <td>Approved</td>
                                    <td style="color:#1a73e8;"><?= $appt_stats['approved'] ?? 0 ?></td>
                                </tr>
                                <tr>
                                    <td>Completed</td>
                                    <td style="color:#198754;"><?= $appt_stats['completed'] ?? 0 ?></td>
                                </tr>
                                <tr>
                                    <td>Cancelled</td>
                                    <td style="color:#ef4444;"><?= $appt_stats['cancelled'] ?? 0 ?></td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="report-box">
                            ...
                            <table class="report-table">
                                ...
                                <tr>
                                    <td>Total Revenue</td>
                                    <td style="color:#198754;">৳<?= number_format($revenue) ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
